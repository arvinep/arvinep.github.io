        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-12 shadow-sm hover:shadow-md transition-all duration-300">
            <p className="text-xl text-gray-700 leading-relaxed text-left font-light">
              Cloud & Platforms
<div className="text-xl text-gray-700 leading-relaxed font-light space-y-4">
  <div>
  ...
  <div>
    <h3 className="text-lg font-semibold text-gray-800">Infrastructure as Code</h3>
    <ul className="list-disc list-inside space-y-1 mt-2">
  ...
  <div>
    <h3 className="text-lg font-semibold text-gray-800">CI/CD & Automation</h3>
    <ul className="list-disc list-inside space-y-1 mt-2">
  ...
  <div>
    <h3 className="text-lg font-semibold text-gray-800">Identity, Security & Access Control</h3>
    <ul className="list-disc list-inside space-y-1 mt-2">
  ...
  <div>
    <h3 className="text-lg font-semibold text-gray-800">Monitoring & Observability</h3>
    <ul className="list-disc list-inside space-y-1 mt-2">
